...
namespace StanNaDanv2
{
    ...
    public class ZaposleniBasic
    {
        ...
        public PoslovniceBasic Poslovnica { get; set; }
        public AgencijaBasic Agencija { get; set; }
        public ZaposleniBasic()
        {

        }
        public ZaposleniBasic(string maticni_broj, string ime, bool isSef, bool isAgent, DateTime datum_zaposlenja, PoslovniceBasic poslovnica, AgencijaBasic agencija)
        {
    ...
    public class SefBasic : ZaposleniBasic
    {
        ...
        public SefBasic() { }
        public SefBasic(DateTime datum_postavljanja, string maticni_broj, string ime, bool isSef, bool isAgent, DateTime datum_zaposlenja, PoslovniceBasic poslovnica, AgencijaBasic agencija)
    ...
    public class SamoZaposleniBasic : ZaposleniBasic
    {
        ...
        public SamoZaposleniBasic( string maticni_broj, string ime, bool isSef, bool isAgent, DateTime datum_zaposlenja, PoslovniceBasic poslovnica, AgencijaBasic agencija)
            : base(maticni_broj, ime, isSef, isAgent, datum_zaposlenja, poslovnica, agencija)
        {
    ...
    public class AgentBasic : ZaposleniBasic
    {
        ...
        public AgentBasic() { }
        public AgentBasic(string strucna_sprema, DateTime datum_postavljanja, string maticni_broj, string ime, bool isSef, bool isAgent, DateTime datum_zaposlenja, PoslovniceBasic poslovnica, AgencijaBasic agencija)
            : base(maticni_broj, ime, isSef, isAgent, datum_zaposlenja, poslovnica, agencija) {
        ...
        public class KvartBasic
    {
        ...
        public KvartBasic(int kvartID, string gradska_zona,  int broj_nekretnina, PoslovniceBasic poslovnica)
        {
            this.kvartID = kvartID;
    ...
    {
        public virtual IList<PoslovniceBasic> Poslovnice { get; set; }
       
        public AgencijaBasic(int agID, string naziv) : base(agID, naziv)
        {
            Poslovnice = new List<PoslovniceBasic>();
    ...
    public class PoslovniceBasic : PoslovnicaPregled
    {
        public virtual AgencijaBasic pripadaAgenciji { get; set; }

        public PoslovniceBasic(int poID, string adresa, string radno_vreme) : base(poID, adresa, radno_vreme)
        {

        }

        public PoslovniceBasic() : base()
        {
